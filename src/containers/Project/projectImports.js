...
export const projectImports = [
  {
    ...
    description:
      "I was hired to build this website for a landing page and to mint an NFT project.",
  ...
  },
  {
    ...
    description:
      "I was asked to build this website as a prototype for a gaming website that aimed to be similar to hypedrop.com. This project never eventualized. ",
